#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/olmoe2/modular_olmoe2.py.
...
from .configuration_olmoe2 import Olmoe2Config


logger = logging.get_logger(__name__)

_CONFIG_FOR_DOC = "Olmoe2Config"


class Olmoe2RMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        Olmoe2RMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Olmoe2Attention(nn.Module):
    ...
    def __init__(self, config: Olmoe2Config, layer_idx: Optional[int] = None):
        ...
        self.q_norm = Olmoe2RMSNorm(self.hidden_size, eps=config.rms_norm_eps)
...
class Olmoe2DecoderLayer(nn.Module):
    def __init__(self, config: Olmoe2Config, layer_idx: int):
        ...
        self.mlp = Olmoe2SparseMoeBlock(config)
...
@add_start_docstrings(
    "The bare Olmoe2 Model outputting raw hidden-states without any specific head on top.",
    OLMOE2_START_DOCSTRING,
)
class Olmoe2PreTrainedModel(PreTrainedModel):
    config_class = Olmoe2Config
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Olmoe2DecoderLayer"]
...
# TODO: re-enable check: Copied from transformers.models.llama.modeling_llama.LlamaModel with Llama->Olmoe2
class Olmoe2Model(Olmoe2PreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`Olmoe2DecoderLayer`]
    ...
    @add_start_docstrings_to_model_forward(OLMOE2_INPUTS_DOCSTRING)
    # Ignore copy
    def forward(
        self,
...
class Olmoe2ForCausalLM(Olmoe2PreTrainedModel, GenerationMixin):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.model = Olmoe2Model(config)
        self.vocab_size = config.vocab_size
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from transformers import AutoTokenizer, Olmoe2ForCausalLM

        >>> model = Olmoe2ForCausalLM.from_pretrained("allenai/Olmoe2-1B-7B-0924")
        >>> tokenizer = AutoTokenizer.from_pretrained("allenai/Olmoe2-1B-7B-0924")
